...
alias ksl='killall -USR1 swaylock'
...
alias gri='git rebase --autosquash -i "origin/$(git-default-branch)"'
alias grm='EDITOR=true git rebase --autosquash -i "origin/$(git-default-branch)"'
alias gr='git rebase'
